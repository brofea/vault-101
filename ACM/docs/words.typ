...
counterclockwise（anticlockwise ）	逆时针
...
intersection	横切; 相交; 交叉点，交叉线; [数] 交集;

Intersection Detection	碰撞测试

intersect	相交

intervals	间隔时间; 间隔；区间
...
search (sequential search)	线性查找（顺序查找）

searching	查找，线索

segment	段，分段;分割；环节; 部分;划分;
